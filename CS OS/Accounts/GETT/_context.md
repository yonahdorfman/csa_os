...
|-------|-------|
| ARR | $66,602 |
| Contract End | 2026-05-31 ⚠️ LAPSED 37d — renewal still Stage 1: Pipeline |
| Next Opp Target | 2027-06-01 (GETT - FY 28 Renewal, Stage 1: Pipeline) |
| Industry | B2B |
| Segment | MM |
| Region | EMEA |
...
| SFDC | [001i0000008X6CaAAK](https://mixpanel.lightning.force.com/lightning/r/Account/001i0000008X6CaAAK/view) |
| GDoc | [Account Plan](https://docs.google.com/document/d/1oCf8rBj9JN5Ervh4xxuoHoKpETmmjtur80z2UQSYVGY/edit?usp=drivesdk) |
...
|------|-------|-------|-------------|
| Guy Cohen POM | — | guy.cohen@gett.com | 2 |
| Dmitry Varsanovich | — | dmitry.varsanovich@gett.com | 1 |
...
Overall health is stable with strong product usage and active engagement. However, the recent Lyft acquisition of the UK business introduces organizational uncertainty that must be monitored closely.

---

## Executive Summary

As of 2026-05-31, GETT has an active pipeline deal for their FY 28 Renewal ($71,603 ARR, closing 2027-06-01). Last interaction: 2026-05-31 via Slack Message. Total Calls Logged: 2. Total Emails Logged: 30. The relationship is active with healthy usage (36K queries across 54+ users), but faces strategic complexity due to Lyft's recent acquisition of GETT's UK operations ([Wikipedia](https://en.wikipedia.org/wiki/Gett)). We need to ensure the Israel team's contract remains secure and independent of the Lyft/Free-Now narrative.

---

## Active Risks

- **[ACTIVE]** [2026-06-03] Lyft acquisition of GETT UK creating organizational and budget uncertainty
- **[ACTIVE]** [2026-06-03] Potential Okta/SSO security gaps with offboarded employees retaining Mixpanel access
...
- No evidence a call was booked. Worth prioritizing given GETT's existing renewal-stage momentum (Stage 4: Buying Process) and the Lyft-acquisition uncertainty already on file — deeper multi-user adoption strengthens the renewal case.
- *Source: Slack 1:1 DM (Tyler Roach), monthly DM sweep 2026-07-02.*

**2026-06-11 | Gmail (morning harvest) — Implementation Issue notification**
- Automated monthly "Implementation Issue" email sent to GETT contacts (Jun 10). Proactively acknowledge with Guy Cohen if relationship warrants.
- Source: Gmail automated notification

**2026-06-10 | Calendar — Jun 18 onsite session canceled**
- Tal Huberman canceled the "Mixpanel // GETT - onsite session" scheduled for Jun 18, 10:30am–12pm.
- Reason unknown. Reschedule when convenient — onsite is high-value for renewal/expansion.
- Source: Calendar cancellation email from tal.huberman@mixpanel.com
